...
<html lang="en">
    <head>
        ...
        <title>CURSOS Y ADMINISTRACION</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">es tiempo de conocernos</div>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor emmannuelsit amet consectetur.</h3>
                </div>
                <div class="row text-center">
                <?php foreach ($lista_servicios as $registros) {?>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-archive fa-stack-2x text-primary"></i>
